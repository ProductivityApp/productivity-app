    ...
    return(
      <div>
        ...
        <div className="input-group mb-3">
          ...
          <button className="btn btn-outline-secondary" type="button" id="button-addon2" onClick={() => { return this.props.addTask(this.props.username, document.getElementById('newTask').value); //took out taskId -JB
        }}>Add Task</button>
        </div>
      </div>
    )
